...
export default function QuoteDetail() {
  ...
  const handleWhatsApp = () => {
    ...
    lines.push(`לקוח: ${quote.customerName}`);
    if (quote.customerPhone) lines.push(`טלפון לקוח: ${quote.customerPhone}`);
    lines.push("");
    lines.push("*פריטים:*");
            ...
            <TableBody>
              {quote.items.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    <TableCell className="font-mono text-gray-500 py-3 text-sm">
                      {item.barcode}
                    </TableCell>
